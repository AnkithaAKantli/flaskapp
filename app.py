...
# Set up uploads directory (used for storing the image files temporarily)
upload_dir = os.path.join(os.path.dirname(__file__), "uploads")
os.makedirs(upload_dir, exist_ok=True)

# Imagga API credentials for image recognition
...
def add_items():
    ...
    try:
        ...
        # Iterate over the data and add/update items in the database
